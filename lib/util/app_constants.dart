...
class AppConstants {
  static const String appName = 'Dhahar Delivery';
  ...
  static const String token = 'dhahar_lib_driver_token';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.indonesian, languageName: 'Indonesian', countryCode: 'ID', languageCode: 'id'),
